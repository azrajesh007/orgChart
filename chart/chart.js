...
OrgChart.prototype.load = function (t) {
    ...
    return this.element.querySelector("g[id='" + t + "']")
    ...
    for (var i = e.target; i != t;) {
        if (i.hasAttribute("id")) return e.stopPropagation(), e.preventDefault(), void this._nodeMouseDownHandler(i, e, r);
        i = i.parentNode
    }
